      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-10 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="mt-3 text-lg text-gray-600 max-w-2xl mx-auto">
            Furniture that fits your lifestyle, crafted with passion and
            delivered with care.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
            <p>
              ...
              , we believe your home should reflect your personality. That's why
              we offer thoughtfully curated pieces designed for style, comfort,
              and durability — without breaking the bank.
            </p>
            <p>
              Our team of designers and furniture experts constantly explore the
              latest trends to bring you high-quality products that blend modern
              and classic aesthetics.
            </p>
            <p>
              Whether you're furnishing a cozy apartment or upgrading your
              entire home, we’re here to make the process seamless and
              enjoyable.
            </p>
